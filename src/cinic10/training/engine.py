...
def train_one_epoch(
    ...
    for images, labels in tqdm(dataloader, desc="train", leave=False, disable=not verbose):
        ...
        # apply MixUp or CutMix if enabled, otherwise use regular images and labels
        if mixer is not None and (use_mixup or use_cutmix):
            ...
            # the mixed_loss function computes the appropriate
            # linear combination of losses for MixUp/CutMix
